 ...
 * body of the POST.
 */
public class PostWriterClassifier {
     ...
     */
    public PostWriterClassifier(String boundary) {
     ...
     */
    public String sendPostData(URLConnection connection, HTTPSamplerBaseClassifier sampler) throws IOException {
    ...
    public void setHeaders(URLConnection connection, HTTPSamplerBaseClassifier sampler) throws IOException {
