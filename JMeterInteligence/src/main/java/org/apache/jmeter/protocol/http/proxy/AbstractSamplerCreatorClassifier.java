 ...
 */
public abstract class AbstractSamplerCreatorClassifier implements SamplerCreatorClassfier {
     ...
     * 
     */
    public AbstractSamplerCreatorClassifier() {
        super();
    }
    ...
    public void postProcessSampler(HTTPSamplerBaseClassifier sampler, SampleResult result) {
        // NOOP
    }
    ...
    public HTTPSamplerBaseClassifier createAndPopulateSampler(HttpRequestHdrClassifier request,
            Map<String, String> pageEncodings, Map<String, String> formEncodings) throws Exception {
        HTTPSamplerBaseClassifier sampler = createSampler(request, pageEncodings, formEncodings);
