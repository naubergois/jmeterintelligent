 ...
 *
 */
public class HttpRequestHdrClassifier {
    ...
    public HttpRequestHdrClassifier() {
     ...
     */
    public HttpRequestHdrClassifier(String httpSamplerName) {
...
//    }
     ...
     */
    public String getProtocol(HTTPSamplerBaseClassifier sampler) {
        if (url.indexOf("//") > -1) {
