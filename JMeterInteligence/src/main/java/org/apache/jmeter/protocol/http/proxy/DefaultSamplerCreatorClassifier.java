...
import org.apache.jmeter.protocol.http.control.gui.HttpTestSampleGuiClassifier;
 ...
 * requests
 */
public class DefaultSamplerCreatorClassifier extends
		AbstractSamplerCreatorClassifier {
	private static final Logger log = LoggingManager.getLoggerForClass();

	/**
     * 
     */
	public DefaultSamplerCreatorClassifier() {
	}
	...
	public HTTPSamplerBaseClassifier createSampler(
		...
		sampler.setProperty(TestElement.GUI_CLASS,
				HttpTestSampleGuiClassifier.class.getName());
