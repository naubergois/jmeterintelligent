 ...
 */
public abstract class HTTPAbstractImplClassifier implements Interruptible, HTTPConstantsInterface {

    protected final HTTPSamplerBaseClassifier testElement;

    protected HTTPAbstractImplClassifier(HTTPSamplerBaseClassifier testElement){
