...
public class MultipartUrlConfigGuiClassifier extends UrlConfigGuiClassifier {
    ...
    public MultipartUrlConfigGuiClassifier() {
        super();
        init();
    }

    // not currently used
    public MultipartUrlConfigGuiClassifier(boolean showSamplerFields) {
        super(showSamplerFields);
        init();
    }

    public MultipartUrlConfigGuiClassifier(boolean showSamplerFields, boolean showImplementation) {
